...
var chart = new ApexCharts(document.querySelector("#apex_line3"), options);
...
var chart = new ApexCharts(document.querySelector("#apex_bar2"), options);
...
var chart = new ApexCharts(document.querySelector("#apex_mixed1"), options);
...
var chart = new ApexCharts(document.querySelector("#apex_mixed2"), options);
...
var chart = new ApexCharts(document.querySelector("#apex_mixed3"), options);
...
var chart = new ApexCharts(document.querySelector("#apex_bubble2"), options2);
...
var chart = new ApexCharts(document.querySelector("#apex_scatter1"), options);
...
var chart = new ApexCharts(document.querySelector("#apex_scatter2"), options);
...
var chart = new ApexCharts(document.querySelector("#apex_pie4"), options);
...
var chart = new ApexCharts(document.querySelector("#apex_radialbar4"), options);
