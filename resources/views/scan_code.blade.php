                    ...
                    <div class="modal-dialog modal-dialog-centered" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="modalTitle">Download the mobile application</h5>
                            ...
                            <div class="modal-body">
                                <!-- Contenu de la modal -->
                                <p>To enjoy this feature, download our mobile application and then install it on your mobile device.</p>
                                <a href="http://192.168.43.108:8000/apk/app-debug.apk" class="btn btn-primary" download="app-debug.apk">Download the application</a>
                            </div>
                        </div>
                    </div>
                </div>
